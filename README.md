# Code for the paper "A Step Towards Inherently Interpretable Causal Machine Learning Models for Decision Support"
...
- The aggregated and individual results for every experiment and the best hyperparameters per model are store in data/gold
